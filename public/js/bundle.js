...
var displayMap = exports.displayMap = function displayMap(locations) {
  // mapbox api
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm95Yml6YXJyZSIsImEiOiJjbG5mMmlxOG0wMzA4MmltYjdoenJ1MjdkIn0.4RAicrif89kZqkX6v-h9cA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NzkvbH2h6W9DNgf8coSXkjfWWa3L8TDt7ZulCLBu74mFYsKSlo0aQpJ9ZljXkaoWihcUKZvc62lLQktAvRfmxB800pTjhG6xl'); // 1) get checkout session from API
          _context.next = 4;
          return (0, _axios.default)("http://127.0.0.1:8000/api/v1/bookings/checkout-sesion/".concat(tourId));
        case 4:
